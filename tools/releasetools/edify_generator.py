...
class EdifyGenerator(object):
  ...
  def FlashMagisk(self):
    ...
    self.script.append('run_program("/tmp/install/bin/busybox", "unzip", "/tmp/magisk/magisk.zip", "META-INF/com/google/android/*", "-d", "/tmp/magisk");')
    self.script.append('run_program("/tmp/install/bin/busybox", "sh", "/tmp/magisk/META-INF/com/google/android/update-binary", "dummy", "1", "/tmp/magisk/magisk.zip");')
